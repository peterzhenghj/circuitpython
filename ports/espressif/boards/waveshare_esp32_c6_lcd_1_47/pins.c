...
static const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    // Left header, screen facing down.
    ...
    // Right header, screen facing down.
    ...
    { MP_ROM_QSTR(MP_QSTR_LCD_BCKL), MP_ROM_PTR(&pin_GPIO22) },
    { MP_ROM_QSTR(MP_QSTR_LCD_D_C), MP_ROM_PTR(&pin_GPIO15) },
